...
class PassCodeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ('owner',), }),
        ('Other Information', {'fields': ('passcode_ingredient', 'auth_token', 'count_passcode_trial', 'session_age', 'monitor_session_age', 'lucky_number', 'childhood_name')}),
    )
