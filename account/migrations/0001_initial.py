    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generated_password', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_age', models.BigIntegerField(default=1)),
                ('monitor_session_age', models.BooleanField(default=True)),
                ('count_passcode_trial', models.BigIntegerField(default=0)),
                ('lucky_number', models.CharField(max_length=255)),
                ('childhood_name', models.CharField(max_length=255)),
